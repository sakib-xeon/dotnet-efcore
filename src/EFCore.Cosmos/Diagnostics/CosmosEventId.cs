...
public static class CosmosEventId
{
    ...
    /// <summary>
    ///     Azure Cosmos DB does not support synchronous I/O. Make sure to use and correctly await only async methods for Cosmos
    ///     data access. See TODO for more information.
    /// </summary>
    /// <remarks>
