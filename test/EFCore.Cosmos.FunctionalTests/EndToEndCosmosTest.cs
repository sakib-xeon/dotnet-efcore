...
//             .ConfigureWarnings(w => w.Log(CosmosEventId.SyncNotSupported))
//             .Options;
//
//         var customer = new Customer { Id = 42, Name = "Theon" };
//
...
//     }
//
//     public class CustomerContext(DbContextOptions dbContextOptions) : DbContext(dbContextOptions)
//     {
...
//                     async () => await context.Set<CustomerWithResourceId>().FindAsync(1, ""))).Message);
//         }
//     }
//
//     [ConditionalFact]
...
//
//     public class CosmosFixture : SharedStoreFixtureBase<CustomerContext>
//     {
